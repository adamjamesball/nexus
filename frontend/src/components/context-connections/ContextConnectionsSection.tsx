...
export function ContextConnectionsSection() {
  const {
    onboarding,
    optimization,
    isFirstTimeUser,
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 text-lg">
                    Help Nexus understand your business for smarter AI insights
                  </p>
                </div>
              </div>
  ...
  // Returning user - show optimization dashboard
  return (
    <div className="mb-8 space-y-6">
      {/* Nexus Brain Status Header */}
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Your AI is continuously learning and optimizing for better insights
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
